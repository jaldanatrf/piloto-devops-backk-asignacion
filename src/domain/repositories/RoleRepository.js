// Puerto/Interfaz para el repositorio de Role (Dominio)
class RoleRepository {
  constructor() {
    if (this.constructor === RoleRepository) {
      throw new Error('RoleRepository is an abstract class and cannot be instantiated directly');
    }
  }
  ...
  async update(id, companyId, roleData) {
